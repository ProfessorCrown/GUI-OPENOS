...
print ("Installation GUI OpenOS.")
term.setCursor (centrX - 20, 2)
print ("Устанавливается графическая оболочка OpenOS.")
...
if not _G._OSVERSION or tonumber(_G._OSVERSION:sub(8, 10)) < 1.5 then
	...
	print ("Обнаружена старая версия OpenComputers mod: GUI требует, чтобы OpenComputers 1.5 или новее работали правильно !")
end
...
local path = "/HIPBIOS/System/Files.cfg"
local URLs = {
EFI = "https://raw.githubusercontent.com/ProfessorCrown/GUI-OPENOS/master/bios.lua",
applicationList = "https://raw.githubusercontent.com/ProfessorCrown/GUI-OPENOS/master/files.cfg",
	}
